...
#define ENCODER_RESOLUTION_1 			262144	// 4 x Max count of Incremental Encoder (4X decoding - quadrature mode)
...
#define SENSOR_SELECTION_CODE_1         BISS
...
#define VELOCITY_Kd_DENOMINATOR_1 		1
    ...
    #define POSITION_Kd_NUMERATOR_1         0
    #define POSITION_Kd_DENOMINATOR_1       1000
    #define MAX_POSITION_LIMIT_1            GEAR_RATIO_1*ENCODER_RESOLUTION_1*8000       // ticks (max range: 2^30, limited for safe operation)
    #define MIN_POSITION_LIMIT_1            -GEAR_RATIO_1*ENCODER_RESOLUTION_1*8000      // ticks (min range: -2^30, limited for safe operation)
#endif
